    ...
    <div className="min-h-screen flex flex-col">
      ...
      <div className="flex-grow bg-white">
        <div className="max-w-4xl mx-auto px-4 py-12">
          ...
          {/* Contact Box */}
          <div className="bg-gradient-to-br from-primary to-primary/90 text-white p-8 rounded-xl shadow-lg mb-12">
          ...
          <section className="mb-12">
            <h2 className="text-3xl font-bold mb-6 border-l-4 border-primary pl-4">Quick Links</h2>
            <div className="flex flex-wrap gap-3">
              <a href="https://www.mywelp.com" className="inline-block bg-primary text-white px-6 py-3 rounded-lg font-semibold hover:bg-primary/90 transition-colors">
                Visit Welp.com
              </a>
          ...
          {/* FAQs */}
          <section className="mb-12">
            <h2 className="text-3xl font-bold mb-6 border-l-4 border-primary pl-4">Frequently Asked Questions</h2>

            <div className="space-y-4">
              <div className="bg-gray-50 p-6 rounded-lg border-l-3 border-primary">
          ...
          <section className="mb-12">
            <h2 className="text-3xl font-bold mb-6 border-l-4 border-primary pl-4">Getting Started Guide</h2>

            <div className="grid md:grid-cols-2 gap-6">
              <div className="bg-gray-50 p-6 rounded-lg border-t-3 border-primary">
              ...
              <div className="bg-gray-50 p-6 rounded-lg border-t-3 border-primary">
                <h3 className="text-xl font-semibold mb-3 text-primary">2. Write Your First Review</h3>
              ...
              <div className="bg-gray-50 p-6 rounded-lg border-t-3 border-primary">
                <h3 className="text-xl font-semibold mb-3 text-primary">3. Search for Customers</h3>
              ...
              <div className="bg-gray-50 p-6 rounded-lg border-t-3 border-primary">
                <h3 className="text-xl font-semibold mb-3 text-primary">4. Build Your Reputation</h3>
          ...
          <section className="mb-12">
            <h2 className="text-3xl font-bold mb-6 border-l-4 border-primary pl-4">App Features Overview</h2>
          ...
          <section className="mb-12">
            <h2 className="text-3xl font-bold mb-6 border-l-4 border-primary pl-4">Community Guidelines</h2>
          ...
          {/* Privacy & Security */}
          <section className="mb-12">
            <h2 className="text-3xl font-bold mb-6 border-l-4 border-primary pl-4">Privacy & Security</h2>
            ...
            <p className="text-gray-700">For more details, read our <a href="/privacy" className="text-primary hover:underline">Privacy Policy</a>.</p>
          </section>

          {/* Troubleshooting */}
          <section className="mb-12">
            <h2 className="text-3xl font-bold mb-6 border-l-4 border-primary pl-4">Troubleshooting</h2>
            ...
            <ul className="list-disc ml-6 space-y-2 text-gray-700 mb-6">
              ...
              <li>If the problem persists, contact support at <a href="mailto:support@mywelp.com" className="text-primary hover:underline">support@mywelp.com</a></li>
            </ul>
          ...
          {/* Contact Information */}
          <section className="mb-12">
            <h2 className="text-3xl font-bold mb-6 border-l-4 border-primary pl-4">Contact Information</h2>

            <h3 className="text-2xl font-semibold mt-6 mb-4">Support Channels</h3>
            <p className="text-gray-700 mb-4">
              <strong>Email Support:</strong> <a href="mailto:support@mywelp.com" className="text-primary hover:underline">support@mywelp.com</a><br />
              Response time: Within 24 hours (Monday-Friday)
            </p>

            <p className="text-gray-700 mb-4">
              <strong>Privacy Inquiries:</strong> <a href="mailto:privacy@mywelp.com" className="text-primary hover:underline">privacy@mywelp.com</a><br />
              For data deletion requests, privacy questions, or GDPR/CCPA requests
            </p>

            <p className="text-gray-700 mb-6">
              <strong>Business Partnerships:</strong> <a href="mailto:hello@mywelp.com" className="text-primary hover:underline">hello@mywelp.com</a><br />
              For partnership opportunities and business inquiries
            </p>

            <h3 className="text-2xl font-semibold mt-6 mb-4">Website</h3>
            <p className="text-gray-700">
              <a href="https://www.mywelp.com" className="text-primary hover:underline">www.mywelp.com</a>
            </p>
          </section>
          ...
          <div className="bg-blue-50 p-8 rounded-lg border-l-4 border-primary">
            ...
            <a href="mailto:support@mywelp.com" className="inline-block bg-primary text-white px-6 py-3 rounded-lg font-semibold hover:bg-primary/90 transition-colors">
              Email Support
            </a>
          </div>
