    ...
    >
      ...
      >
        ...
        <g transform={`translate(${iconSize * 0.65}, ${iconSize * 0.3}) rotate(12)`}>
          {/* Right arm (0 degrees) */}
          <path
            d={`M ${asteriskSize * 0.04} 0 Q ${asteriskSize * 0.18} -${asteriskSize * 0.1} ${asteriskSize * 0.34} -${asteriskSize * 0.05} 
                Q ${asteriskSize * 0.38} 0 ${asteriskSize * 0.34} ${asteriskSize * 0.05} 
                Q ${asteriskSize * 0.18} ${asteriskSize * 0.1} ${asteriskSize * 0.04} 0`}
            fill="white"
          />
          ...
          {/* Period positioned at midpoint of arc between top-left arm (216°) and right arm (0°) - which is 108° */}
          <circle
            cx={-asteriskSize * 0.05}
            cy={-asteriskSize * 0.19}
            r={asteriskSize * 0.08}
            fill="white"
          />
        </g>
