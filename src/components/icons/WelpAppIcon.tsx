    ...
    >
      ...
      >
        ...
        <g transform={`translate(${iconSize * 0.65}, ${iconSize * 0.3}) rotate(12)`}>
          {/* Right arm (0 degrees) */}
          <path
            d={`M ${asteriskSize * 0.04} 0 Q ${asteriskSize * 0.16} -${asteriskSize * 0.08} ${asteriskSize * 0.30} -${asteriskSize * 0.04} 
                Q ${asteriskSize * 0.34} 0 ${asteriskSize * 0.30} ${asteriskSize * 0.04} 
                Q ${asteriskSize * 0.16} ${asteriskSize * 0.08} ${asteriskSize * 0.04} 0`}
            fill="white"
          />
          ...
          {/* Period positioned between top-left and right arms, moved slightly right */}
          <circle
            cx={asteriskSize * 0.08}
            cy={-asteriskSize * 0.18}
            r={asteriskSize * 0.06}
            fill="white"
          />
        </g>
