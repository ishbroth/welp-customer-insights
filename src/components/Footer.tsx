...
const Footer = () => {
  ...
  return (
    <footer className="bg-welp-dark text-white py-4 md:py-6 mt-auto w-full mx-0 -ml-8 -mr-8 md:w-screen md:relative md:left-1/2 md:-translate-x-1/2 md:ml-0 md:mr-0 z-40">
