...
const SearchBox = ({ 
  ...
  const handleSearch = (e: React.FormEvent) => {
    ...
    if (onSearch) {
      ...
      // Default behavior - navigate to search results page with all parameters
      navigate(`/search?lastName=${encodeURIComponent(lastName)}&firstName=${encodeURIComponent(firstName)}&phone=${encodeURIComponent(phone)}&address=${encodeURIComponent(firstWordOfAddress)}&city=${encodeURIComponent(city)}&state=${encodeURIComponent(state)}&zipCode=${encodeURIComponent(zipCode)}&fuzzyMatch=true&similarityThreshold=0.7`);
    }
  };
